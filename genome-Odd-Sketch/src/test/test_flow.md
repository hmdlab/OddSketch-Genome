# OddSketch Test Flow Documentation

## 概要
OddSketchのテスト・評価における処理フローと各ファイルの役割を説明します。
...
## 2. OddSketchでのJaccard係数推定

### 担当ファイル: cal_diverse_oddsketch.py

処理内容:
1. スケッチ生成: ../oddsketch sketch コマンド実行
   - k-mer長: 64
   - スケッチサイズ: 8192
...
出力ファイル:
- data/test_genomes/sketches/genome1_001.fna.sketch ~ (400個のスケッチファイル)
- data/test_genomes/jaccard_oddsketch_results.txt (推定値)
  フォーマット:
...
出力PNG:
- data/test_genomes/results/jaccard_scatter_full.png
- data/test_genomes/results/jaccard_scatter_high_sim.png
- data/test_genomes/results/jaccard_scatter_high_sim_zoomin.png
- data/test_genomes/results/mutation_vs_accuracy_diverse.png
- data/test_genomes/results/dataset_comparison.png
