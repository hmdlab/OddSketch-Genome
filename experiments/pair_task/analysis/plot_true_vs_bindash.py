...
def main() -> None:
    ...
    ap.add_argument("--csv", default=str(results_dir / "comparison_results_bindash.csv"))
    ap.add_argument("--out", default=str(figures_dir / "bindash_true_vs_estimate.png"))
    ap.add_argument(
        "--rmse-ylim-max",
        type=float,
        default=None,
    ...
    ax4.hist((df["jaccard_bindash"] - df["jaccard_true"]).values, bins=30, alpha=0.7, color="lightgreen", edgecolor="black")
