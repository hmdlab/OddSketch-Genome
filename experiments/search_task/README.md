...
When you run via `experiments/scripts/run_benchmark.sh`, use
`experiments/configs/search_task.config.json` and outputs are written under
`experiments/outputs/search_task/`.
