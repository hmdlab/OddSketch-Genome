...
def main():
    ...
    if not (true_tsv.exists() and odd_tsv.exists() and bds_tsv.exists()):
        raise SystemExit(f"missing inputs: {true_tsv}, {odd_tsv}, {bds_tsv}")

    true_map = load_map(true_tsv, q_col=0, nn_col=1)
